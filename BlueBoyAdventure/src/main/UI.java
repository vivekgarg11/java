...
//				gp.playSE(17);
	...
	public void drawInventory(Entity entity, boolean cursor) {
		...
		for (int i = 0; i < entity.inventory.size(); i++) {
			...
			if (entity == gp.player && entity.inventory.get(i).amount > 1) {
				...
				amountX = getXforAllighToRightText(s, slotX + 44);
	...
	public void options_top(int frameX, int frameY) {
		...
		// MUSIC VOLUME
		textY += gp.tileSize;
		g2.drawRect(textX, textY, 120, 24);// 120/5=24 dividing into 5 parts
	...
	public void trade_buy() {
		...
		if (itemIndex < npc.inventory.size()) {
			...
			String text = "" + price;
			x = getXforAllighToRightText(text, gp.tileSize * 8 - 20);
	...
	public void trade_sell() {
		...
		if (itemIndex < gp.player.inventory.size()) {
			...
			String text = "" + price;
			x = getXforAllighToRightText(text, gp.tileSize * 18 - 20);
			g2.drawString(text, x, y + 34);
