...
//		projectile = new OBJ_Rock(gp);
	...
	public void attacking() {
		...
		if (spriteCounter > 5 && spriteCounter <= 25) {
			...
			int solidAreWidth = solidArea.width;
			int solidAreaHeight = solidArea.height;

			// Adjust player's world X/Y for attackArea
			switch (direction) {
			case "up":
			...
			int monaterIndex = gp.cChecker.checkEntity(this, gp.monster);
			damageMonster(monaterIndex, attack);
